        ...
        <div className="rectangleBe">
          ...
          <div className="parts1">
            <div className="circle1">
              ...
              />
              <div className="addp1">
                <label htmlFor="input" className="img-upload1">
                  {" "}
                  <FaCamera className="camera1" />
                </label>
              </div>
            </div>

            <div className="information1">
              <label className="yourname1" for="name">
                Name:
              </label>
              <input
                className="style2"
              ...
              />{" "}
              <br />
              <label className="mail1" for="email">
                Email:
              </label>
              <input
                className="style2"
              ...
              />{" "}
              <br />
              <label className="contactNumber1" for="contact">
                Phone No.:
              </label>
              <input
                className="style2"
              ...
              />{" "}
              <br />
              <label className="address1" for="address">
                Address:
              </label>
              <textarea
                className="style3"
              ...
              />{" "}
              <br />
              <label className="education1" for="education">
                Qualifications:
              </label>
              <textarea
                className="style3"
              ...
              />{" "}
              <br />
              <label className="domains1" for="domains">
                Domains:
              </label>
              <textarea
                className="style3"
              ...
              />{" "}
              <br />
              <label className="industry" for="industry">
                Industry:
              </label>
              <input
                className="style2"
              ...
              />{" "}
              <br />
              <label className="experience" for="experience">
                Experience:
              </label>
              <textarea
                className="style3"
              ...
              />{" "}
              <br />
              <label className="achieve" for="achieve">
                Achievements:
              </label>
              <textarea
                className="style3"
