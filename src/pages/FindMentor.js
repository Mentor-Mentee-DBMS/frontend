        ...
        <section className="findMentor">
          <div className="rectangleFind">
            ...
            <div classname="information">
                <label className="yourname" for="name">Name:</label>
                <input
                    className="style"
                    type="text"
                    id="name"
                ...
                <label className="contactNumber" for="contact">Phone No.:</label>
                <input
                    className="style"
                    type="number"
                    id="contact-number"
               ...
               <label className="birthday" for="birthday">DOB:</label>
                ...
                <label className="address" for="address">Address:</label>
                <textarea
                    className="style1"
                    type="text"
                    id="address"
                ...
                <label className="url" for="url">Linkedin Url:</label>
                <input
                    className="style"
                    type="text"
                    id="url"
                ...
                <label className="bio" for="bio">About/Bio:</label>
                <textarea
                     className="style1"
                     type="text"
                     id="bio"
                ...
                <label className="school" for="school-name">School Name:</label>
                <input
                     className="style"
                     type="text"
                     id="school"
                ...
                <label className="college" for="college-name">College Name:</label>
                <input
                     className="style"
                     type="text"
                     id="college"
                ...
                <label className="education" for="education">Qualification:</label>
                <textarea
                     className="style1"
                     type="text"
                     id="education"
                ...
                <label className="domains" for="domains"> Domains:</label>
                <textarea
                    className="style1"
                     type="text"
                     id="domains"
            ...
            <div className="click">
                <button className="submitBtn"><Link className="submit" to='/searchMentor'>SUBMIT</Link></button>
            </div>
          </div>
